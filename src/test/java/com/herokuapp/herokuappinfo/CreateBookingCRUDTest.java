...
public class CreateBookingCRUDTest extends TestBase {
    ...
    public static String firstname = "Sanket"+ TestUtils.getRandomValue();
    public static String lastname = "Desai"+TestUtils.getRandomValue();
    public static Integer totalprice = 185;
